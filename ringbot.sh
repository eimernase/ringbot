...
#  / ___/ / __ \/ __ `/ __ \/ __ \/ __/
# / /  / / / / / /_/ / /_/ / /_/ / /_  
#/_/  /_/_/ /_/\__, /_.___/\____/\__/ v0.0.1 
#             /____/  by eimernase
# 
...
# Variants
v1=( 1495 1365 1240 1120 980 850 730 )
v2=( 1120 1240 980 1365 850 1495 730 )
v3=( 730 850 980 1120 1240 1365 1495 )

# Playfield coordinates
posX=( 730 850 980 1120 1240 1365 1495 )
posY=( 180 310 430 550 670 790 910 )


if [ "$screenres" == "1280x800" ]; then
...
function tile_holen() {
	...
	#xdotool mousemove 730 310
	xdotool mousemove 530 250
	sleep 0.01
	scrot assets/$screenres/screenshot.png
	#convert assets/$screenres/screenshot.png -crop 128x128+662+245 assets/$screenres/tile.png 
	convert assets/$screenres/screenshot.png -crop 89x89+483+203 assets/$screenres/tile.png 
...
#	xdotool mousemove 185 225
#	xdotool click 1
#	xdotool mousemove 75 165
#	xdotool click 1
	xdotool mousemove 200 215
	xdotool click 1
	xdotool mousemove 75 160
	xdotool click 1

	# Restart?
	scrot assets/$screenres/restart_screenshot.png
#	convert assets/$screenres/restart_screenshot.png -crop 271x107+817+438 assets/$screenres/yes_check.png 
...
#		xdotool mousemove 990 520
		xdotool mousemove 660 380
		xdotool click 1	
	fi
...
#	xdotool mousemove 1165 520
#	xdotool click 1
#	xdotool mousemove 1095 520
#	xdotool click 1
	# Block error
	xdotool mousemove 765 380
	xdotool click 1
...
#	convert assets/$screenres/gamecheck_screenshot.png -crop 432x90+20+185 assets/$screenres/gamecheck_new.png 
